...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "xgb_global"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xd5b2d37422817a37315b310e79d97a00"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0xf417628e45e6fa6a)
...
#define STAI_NETWORK_OUT_1_FORMAT      (STAI_FORMAT_S32)
#define STAI_NETWORK_OUT_1_SHAPE       {1}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_RANK        (0)
#define STAI_NETWORK_OUT_1_SIZE        (())
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (4)

#define STAI_NETWORK_OUT_2_ALIGNMENT   4
#define STAI_NETWORK_OUT_2_NAME        (NULL)
#define STAI_NETWORK_OUT_2_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_2_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_2_SHAPE       {1,4}
#define STAI_NETWORK_OUT_2_BATCH       (1)
#define STAI_NETWORK_OUT_2_CHANNEL     (4)
#define STAI_NETWORK_OUT_2_RANK        (1)
#define STAI_NETWORK_OUT_2_SIZE        ((4))
#define STAI_NETWORK_OUT_2_SIZE_BYTES  (16)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (560)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (560)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (560)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (560)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (63520)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (63520)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (63520)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (63520)
